...
def fetch_gcloud_secrets(secret, version="latest", env_file=".env"):
    """ Fetches data from google cloud secrets manager and writes to a local file
    :parameter secret: The name of the secret in google cloud Secret Manager
    :parameter version: The verison of the secret to use, default "latest"
    :parameter env_file: Name of the file to write secrets to, default ".env"
    :return: None
    """
